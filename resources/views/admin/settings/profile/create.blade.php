                                    ...
                                    <form class="g-3" action="{{ $c_menu->url }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-2">
                                                ...
                                                <input type="text" class="form-control @error('home_number') is-invalid @enderror" id="home_number" name="home_number" value="{{ old('home_number') }}">
                                                @error('home_number')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-12">
                                                ...
                                                <textarea name="address_1" id="address_1" class="form-control @error('address_1') is-invalid @enderror" cols="15" rows="5">{!! old('address_1') !!}</textarea>
                                                @error('address_1')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <select class="single-select form-control @error('role') is-invalid @enderror" id="role" name="role">
                                                    <option value="tec" @if (old('role') == 'tec') selected @endif>Pengajar</option>
                                                    <option value="pat" @if (old('role') == 'pat') selected @endif>Member</option>
                                                </select>
                                                @error('role')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-4">
                                                <label class="form-label" for="password">Kata Sandi <small class="text-danger">*</small></label>
                                            ...
                                            <div class="col-4">
                                                <label class="form-label" for="repassword">Kata Sandi Ulang <small class="text-danger">*</small></label>
                                                <input type="password" class="form-control @error('repassword') is-invalid @enderror" id="repassword" name="repassword" value="{{ old('repassword') }}">
                                                @error('repassword')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
