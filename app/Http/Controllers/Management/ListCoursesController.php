...
{
    protected $path = '/admin/list-courses';
    ...
    public function index()
    {
        ...
        return view('admin.management.list_courses.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('admin.management.list_courses.create', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->list_courses->where('id', $id)->update($data);
